...
DROP TABLE IF EXISTS city_dataset;
DROP TABLE IF EXISTS county_dataset;
...
CREATE TABLE ghgp_data_carbon_2022 (
	...
	FOREIGN KEY (City) REFERENCES city_dataset (city),
	FOREIGN KEY (County) REFERENCES county_dataset (county)
);
